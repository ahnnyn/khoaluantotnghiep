...
import {
  ...
  saveMessage,
  fetchMessages,
} from "services/chatbox/api.chat";
...
const Chat = () => {
  ...
  const avatarUrl = (user) => {
    if (!user || !user.hinhAnh) return "/assets/images/chat-icon/avatar.png";
  ...
  return (
    <div className="chat">
      ...
      <div className="center" style={{ overflowY: "auto", flex: 1, overflowX: "hidden" }}>
              ...
              <div className="texts">
                ...
                {(() => {
                  if (msg.img) {
                    ...
                    return <p style={{ padding: 8, backgroundColor: "#ffffff", borderRadius: "8px" }}>{msg.text}</p>;
                  } else {
                    return null;
                  }
                })()}

                <span style={{marginTop: -40}}>{format(msg.createdAt)}</span>
              </div>
            </div>
          );
        })}
      ...
      <div className="bottom">
        <div className="icons">
          ...
          <label htmlFor="img-upload">
            <img src="/assets/images/chat-icon/img.png" alt="upload-image" title="Gửi ảnh" />
          </label>
          <input
            type="file"
            id="img-upload"
          ...
          <label htmlFor="file-upload">
            <img
              src="/assets/images/chat-icon/attach_file_24dp_FFFF.png"
              alt="upload-file"
              title="Gửi file"
            />
          </label>
        ...
        <input
          ...
          style={{ height: "40px", flex: 1, padding: "0 10px" }}
        />
        <div className="emoji">
          <img
            src="/assets/images/chat-icon/emoji.png"
            alt="emoji"
